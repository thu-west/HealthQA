...
public class Evaluation {
	...
	static {
		...
		map.put("y", 3); label.put(3, "y");
		map.put("c", 4); label.put(4, "c");
		map.put("t", 5); label.put(5, "t");
		map.put("o", 6); label.put(6, "o");
	...
	public static void main(String[] args) throws IOException {
		...
		evaluation("res/data/answer-entity/test/test.result.tmp");
		System.out.println("----no punc");
		evaluation("res/data/answer-entity/test/test.nopunc.result.tmp");
	}
