...
public class Evaluation {
	...
	static {
		...
		map.put("ju", 1); label.put(1, "ju");
		map.put("dou", 2); label.put(2, "dou");
	}
	...
	public static void main(String[] args) throws IOException {
		...
		evaluation("res/data/complete-semantic-split-crf/test/test.500.result.tmp");
		System.out.println("----1000");
		evaluation("res/data/complete-semantic-split-crf/test/test.1000.result.tmp");
		System.out.println("----1500");
		evaluation("res/data/complete-semantic-split-crf/test/test.1500.result.tmp");
		System.out.println("----2000");
		evaluation("res/data/complete-semantic-split-crf/test/test.2000.result.tmp");
		System.out.println("----2500");
		evaluation("res/data/complete-semantic-split-crf/test/test.2500.result.tmp");
	}
